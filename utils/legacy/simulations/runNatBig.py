...
with tf.variable_scope("Encoder"):
    filter_shapes = [(7, 89), (3, 17), (2, 6),(2, 6), (2, 5), (1, 5), (1, 3)]
    input_channels = [4, 32, 64, 128, 128, 128, 128]
    output_channels = [32, 64, 128, 128, 128, 128, 200]
    strides = [[1, 2, 2, 1], [1, 2, 3, 1], [1, 1, 1, 1],[1, 2, 3, 1], [1, 1, 1, 1], [1, 1, 2, 1], [1, 1, 1, 1]]
    names = ['First_Conv', 'Second_Conv', 'Third_Conv', 'Third_Conv_b', 'Fourth_Conv','Fourth_Conv_b', 'Fifth_Conv']
...
with tf.variable_scope("Decoder"):
    ...
    input_channels = [32, 64, 64]
    output_channels = [64, 64, 257]
    strides = [[1, 2, 2, 1],[1, 1, 1, 1],[1, 2, 2, 1]]
    names = ['First_Deconv', 'First_Deconv_b','Second_Deconv']
...
aContextEncoderNetwork = StftGapContextEncoder(model=aModel, batch_size=batch_size, target_model=aTargetModel, window_size=window_size,
                                               gap_length=gap_length, learning_rate=1e-3, name='nat_stft_gap_1_big')
